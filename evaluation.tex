...
In terms of DML types, the majority of bugs are caused by \texttt{UPDATE} statements (15/21), while the remaining involve \texttt{DELETE} (4/21) and \texttt{INSERT} (2/21), indicating that value-modifying operations are particularly error-prone. 
From a structural perspective, most bugs are triggered by complex query constructs: 18 out of 21 bugs involve subqueries, 9 involve joins, 9 involve set operations, and 16 involve logic operators. 
...
\textbf{Case Study.}
Due to space limitations, we present additional representative and interesting bug cases at \url{https://anonymous.4open.science/r/DMLScope-9F03/}. \lin{add a url and false positive}
