...
We implemented \toolname\ as a prototype DBMS testing system in Python, consisting of 15,656 lines of code.
...
\toolname\ is primarily designed for MySQL-compatible systems, including TiDB and MariaDB, but its modular architecture allows for straightforward adaptation to other DBMS dialects by customizing syntax- and type-related components.
In practice, such adaptation requires only lightweight modifications, and can be further automated using tools such as \textsc{QTRAN}~\cite{lin2025qtran}, which facilitates cross-dialect deployment of MT techniques.