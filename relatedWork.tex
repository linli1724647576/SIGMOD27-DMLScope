...
Its main goal is not merely to increase query diversity, but to expose subtle logical bugs in DML execution by checking whether state effects satisfy expected semantic relations. 
